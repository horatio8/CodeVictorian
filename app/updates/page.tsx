    ...
    <>
      ...
      <section className="gradient-navy relative overflow-hidden pt-40 pb-24 lg:pt-48 lg:pb-32 on-dark">
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          <span className="eyebrow eyebrow-both">Monthly Newsletter</span>
          ...
          <p className="lede mx-auto mt-8 max-w-2xl">
            One monthly dispatch — campaign progress, policy briefings, personal
            updates from the field, and ways to get involved. No noise.
          </p>
        </div>
      </section>
